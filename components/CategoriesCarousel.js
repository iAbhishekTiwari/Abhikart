...
import c1headphones from "../public/c1-headphones.jpg"
import c2electronics from "../public/c2-electronics.jpg"
    ...
    <>
          <div className="flex w-full justify-evenly border-b-6 border-gray-400">
              ...
              >
                  ...
                  <div
                      ref={Fashion}
                      className="hidden absolute top-[9.8rem] md:top-[10.75rem] z-10 shadow-2xl bg-white p-3 space-y-4"
                  >
          ...
          <div className="w-[100vw] h-auto"><Carousel
              autoFocus
              autoPlay
              infiniteLoop
              showThumbs={false}
              ...
              showStatus={false}
          >
              <div className="block w-[100vw] h-fit py-0 ">
                  <Image src={c1headphones} layout="responsive" className="my-0 py-0" priority />
                  <div className="absolute flex justify-around items-center gap-6 bottom-8 w-full overflow-hidden">
              ...
              <div className="block w-[100vw] h-fit py-0">
                  <Image layout="responsive" src={c2electronics} className="my-0 py-0" priority />
                  <div className="absolute flex justify-around items-center gap-6 bottom-8 w-full overflow-hidden">
              <div className="flex flex-col bg-white p-2 text-blue-600 rounded-full overflow-hidden h-12 w-12 sm:w-20 sm:h-20 md:h-28 md:w-28 lg:w-40 lg:h-40 object-contain object-center items-center justify-center">
                  <Lottie animationData={buy} />
              </div>
